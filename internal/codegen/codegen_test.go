	...
	cases := []testcase{
		{
			...
			inConfig: config.OutputConfig{
				...
				Command: "gunion --type myUnion --src source.go --no-default",
				Getters: true,
				Setters: true,
				Match:   true,
				Default: false,
		...
		},
		{
			...
			inConfig: config.OutputConfig{
				...
				Command: "gunion --type myUnion --src source.go --no-getters --no-setters --no-match --no-default",
				Getters: false,
				Setters: false,
				Match:   false,
				Default: false,
		...
		},
		{
			...
			inConfig: config.OutputConfig{
				...
				Command: "gunion --type myUnion --src source.go",
				Getters: true,
				Setters: true,
				Match:   true,
				Default: true,
